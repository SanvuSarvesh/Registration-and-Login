...
import com.example.authenticationservice.exceptions.apiError.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleM3AdaptorUtilException(UserServiceException ex) {
        ApiError apiError;
